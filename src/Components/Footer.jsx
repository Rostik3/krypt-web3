...
const Footer = ({ heightIfLoginPage }) => {
    return (
        <div className={`${heightIfLoginPage && heightIfLoginPage} w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer`}>
